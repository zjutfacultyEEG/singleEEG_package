...
% SINGLEEEG MATLAB code for singleEEG.fig
%      SINGLEEEG, by itself, creates a new SINGLEEEG or raises the existing
%      singleton*.
%
%      H = SINGLEEEG returns the handle to a new SINGLEEEG or the handle to
%      the existing singleton*.
%
%      SINGLEEEG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SINGLEEEG.M with the given input arguments.
%
%      SINGLEEEG('Property','Value',...) creates a new SINGLEEEG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before singleEEG_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to singleEEG_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help singleEEG

% Last Modified by GUIDE v2.5 13-Nov-2021 10:06:26
...
% --- Executes just before singleEEG is made visible.
function singleEEG_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to singleEEG (see VARARGIN)

% Choose default command line output for singleEEG
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes singleEEG wait for user response (see UIRESUME)
...
% handles    structure with handles and user data (see GUIDATA)
s2=get(handles.edit3,'string');
[wt,f,~] = cwt(handles.V_mid,'amor',str2double(s2));%morse,amor,bump
loc_f=find(f<50);
